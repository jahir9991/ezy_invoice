...
(function () {
    ...
    angular.module('InvoiceAdmin.home.services')
        .controller('ServiceCategoriesCtrl', ServiceCategoriesCtrl);

    /** @ngInject */
    function ServiceCategoriesCtrl($q, $filter, editableOptions, editableThemes, statusModel, $uibModal, categoryModel, toastr, jamodal, ngDialog) {
        var vm = this;
