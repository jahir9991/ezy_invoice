...
(function () {
    ...
    /** @ngInject */
    function ProductListCtrl($q, statusModel, productModel, subcategoryModel, toastr, jamodal, ngDialog) {
        var vm = this;
        ...
        function insertFormSubmit(insertData) {
            ...
            productModel.save(insertData, function (response) {
                vm.insertData = {};
        ...
        function callServer(tableState) {
            ...
            productModel.getProductsSearch_list(d, function (result) {
                console.log(result);
        ...
        function productDelete() {
            ...
            productModel.delete({id: id}, function (response) {
                ngDialog.close();
                jamodal.success('Success', response.sms);
        ...
        function update(key, id, newData, oldData) {
            ...
            if (newData !== oldData) {
                ...
                productModel.update({id: id, data: data}, function (response) {
                    toastr.success(response.sms);
                    d.resolve()
