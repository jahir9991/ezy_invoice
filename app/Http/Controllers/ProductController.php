...
class ProductController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Product::with('status', 'subcategory.category')->paginate($request->input('per_page'));
    }
    ...
    public function scopeSearchByKeyword($pagination, $search, $sort)
    {
        ...
        try {
            ...
            $data = Product::with('status', 'subcategory')
                ...
                ->where("subcategory_id", "LIKE", ($subcategory == null ? "%%" : "$subcategory"))
    ...
    public function getProductsSearch_list(Request $request)
    {
    ...
    public function getProductsBySearch_sell(Request $request)
    {
    ...
    public function getProductsBySearch_buy(Request $request)
    {
        ...
        try {
            ...
            $data = Product::where(function ($q) use ($searchTerm) {
                $q->where('name', 'LIKE', "%$searchTerm%")
                    ->orWhere('brand', 'LIKE', "%$searchTerm%")
                    ->orWhere('id', 'LIKE', "%$searchTerm%");
            })
